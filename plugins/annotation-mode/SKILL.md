...
If the user says `like`, `better`, `redesign`, or `improve`, return to [$product-design-router](../product-design-router/SKILL.md).
...
- Refer to the Plugin router [$product-design-router](../product-design-router/SKILL.md) before proceeding.
- Follow [$critical-overrides](../../references/critical-overrides.md).

## User Context

Before starting, load [$product-design-context](../product-design-context/SKILL.md) and run its preflight script when local shell access is available.
...
2. Open the source URL using the Browser Choice rule in [$product-design-router](../product-design-router/SKILL.md#browser-choice).
...
12. Run [product-design-qa](../product-design-qa/SKILL.md) as the blocking build gate.
...
- Only hand off after [product-design-qa](../product-design-qa/SKILL.md) passes.
