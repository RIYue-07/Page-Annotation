...
description: Use when users ask to save or load the Product Design references used by this plugin, including URLs, images, Figma files, codebases, tokens, and brand assets.
---
...
```text
$CODEX_HOME/state/plugins/annotation-mode/product-design/user-context.md
```

Saved screenshots and reference images live next to it:

```text
$CODEX_HOME/state/plugins/annotation-mode/product-design/assets/
```
