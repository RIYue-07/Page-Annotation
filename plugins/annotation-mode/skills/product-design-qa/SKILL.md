...
description: Use when checking a prototype from this plugin against an image, URL, Figma frame, mockup, or other visual source before handoff.
---
...
Do not use this skill for broad UX critique, design critique, product audits, or flow reviews.
...
2. Capture evidence.
   ...
   - For web/app implementations, follow the Browser Choice rule in [product-design-router](../product-design-router/SKILL.md#browser-choice). In ChatGPT Work Mode, follow the active build skill's "Previewing prototypes in ChatGPT Work Mode" section before opening a local implementation. Then capture screenshots at the intended viewport.
